...
>
	...
	<div class="flex items-center space-x-4">
		...
		<!-- GIthub -->
		<a class="text-gray-700 dark:text-gray-200" href={REPO_URL} aria-label="GitHub source">
			<svg aria-hidden="true" class="h-[26px] w-[26px]" fill="currentColor" viewBox="0 0 24 24"
				><path
					fill-rule="evenodd"
		...
		<button
			...
			class="w-9 h-9 ml-1 bg-gray-200 rounded-lg dark:bg-gray-600 flex items-center justify-center hover:ring-2 ring-gray-300 transition-all"
