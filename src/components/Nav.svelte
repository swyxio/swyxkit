...
>
	...
	<div class="flex items-center space-x-2">
		...
		<!-- RSS -->
		<a class="text-gray-700 dark:text-gray-200"  rel="external" href="/api/rss.xml"
		aria-label="RSS">
			<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
				<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 5c7.18 0 13 5.82 13 13M6 11a7 7 0 017 7m-6 0a1 1 0 11-2 0 1 1 0 012 0z" />
			</svg>
		</a>
		<!-- GIthub -->
		<a class="text-gray-700 dark:text-gray-200" href="https://github.com/sw-yx/swyxkit"
